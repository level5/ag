...
var atlasClient = require('../client/atlasClient'); // (C) Copyright 2017-2018 Hewlett Packard Enterprise Development LP
...
async function testReturnCo() {
  let i = await Promise.resolve(1);
  return i;
}

let check = async function (a, b, c) {
  let i = await Promise.resolve(1 + a + b + c);
  return i;
};
// 
// let update = (a, b, c) => {
